...
export default class PortfolioForm extends Component {
    ...
    handleSubmit(event) {
        axios.post("https://trueescape.devcamp.space/portfolio/portfolio_items", this.buildForm(), {withCredentials: true}).then(response => {console.log('response', response)}).catch(error => {console.log('error', error)});
